...
* **Invariant Feature Learning for Counterfactual Watch-time Prediction in Video Recommendation**
    <br> *Proceedings of the AAAI Conference on Artificial Intelligence (**AAAI**), 2026.* (CCF-A)
...
* **EPiDA: an Easy Plug-in Data Augmentation Framework for High Performance Text Classification**
    ...
    <br> *Proceedings of the North American Chapter of the Association for Computational Linguistics (**NAACL**), 2022.* (CCF-B)

### 2021
* **DP-SSL: Towards Robust Semi-supervised Learning with A Few Labeled Samples**
    <br> Yi Xu, **[Jiandong Ding]**, Lu Zhang, Shuigeng Zhou.
    <br> *Advances in Neural Information Processing Systems (**NeurIPS**), 2021.* (CCF-A)

* **Weakly-supervised Text Classification Based on Keyword Graph**
    <br> Lu Zhang, **[Jiandong Ding]**, Yi Xu, Yingyao Liu, Shuigeng Zhou.
    <br> *Proceedings of the Conference on Empirical Methods in Natural Language Processing (**EMNLP**), 2021.* (CCF-B)

* **Effectiveness of AI assistance in live-streaming**
    <br> *International Conference on Information Systems (**ICIS**), 2021.*
